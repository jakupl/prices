...
const sources = [
  ...
  { site: "CSFLOAT", key: "csfloat", url: `https://jakupl.github.io/csfloat/floatPriceList.json`, custom: "csfloat" },
...
async function fetchSiteItems(source) {
  ...
  // 🔥 specjalna obsługa CSFLOAT – inny format JSON
  if (source.custom === "csfloat") {
    if (!json || typeof json.items !== "object") {
      throw new Error("Nieoczekiwany format CSFLOAT (brak items)");
    }
